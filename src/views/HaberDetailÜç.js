...
function HaberDetailÜç({navigation}) {
...
return (
    ...
    <View style={[styles.headerView ]}>
      ...
      /><Text style={styles.titleText}>FLAŞ FLAŞ FLAŞ TEST HABER 3 :D </Text>
      </View>
    
    <ScrollView style={styles.scrollView} contentContainerStyle={[styles.contentView,{backgroundColor: theme.backgroundColor}]}>
     
      <Text style={[styles.denemeText , {color: theme.textColor}]}>flash flash flash haber açıklama</Text>
